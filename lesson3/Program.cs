...
{
    int muN = 0;     // Сразу берём последнюю цифру числа - оно же первая цифра в новом числе
    int n = Num;       // Копия заданного числа, которую будем "кромсать", уже без последней цифры
