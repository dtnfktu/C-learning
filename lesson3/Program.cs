...
{
    int muN = Num % 10;     // Сразу берём последнюю цифру числа - оно же первая цифра в новом числе
    int n = Num / 10;       // Копия заданного числа, которую будем "кромсать", уже без последней цифры
